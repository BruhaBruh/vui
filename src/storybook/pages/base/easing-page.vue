	...
	>
		...
		>
			<section
				...
				class="bg-on-surface-variant size-8 rounded-full transition duration-extra-long-4 scale-75 group-hover/track:scale-100 group-hover/track:translate-x-[calc(var(--spacing-64)-var(--spacing-10))]"
			/>
		</section>
	</section>
</template>
